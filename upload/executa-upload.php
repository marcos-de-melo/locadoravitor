...
$extensoes_validas = array(".jpg", ".png", ".bmp", ".jpeg", ".gif");

$caminho_absoluto = "../img/fotos-capa-videos";
...
if (isset($_FILES['arquivo']['name'])):
    ...
    $nome_arquivo_novo = $idVideo . $extensao;
    ...
    if (move_uploaded_file($arquivo_temporario, "$caminho_absoluto/$nome_arquivo_novo")):
        $sql = "UPDATE tbvideos SET nomeCapaVideo= '{$nome_arquivo_novo}' WHERE idVideo = '{$idVideo}'";
        mysqli_query($conexao, $sql);
        echo "./img/fotos-capa-videos/{$nome_arquivo_novo};concluido";
    else:
